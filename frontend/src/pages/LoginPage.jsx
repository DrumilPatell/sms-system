      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-8 shadow-2xl">
          ...
          <div className="mt-6 text-center text-sm text-slate-400">
            By signing in, you agree to our <span className="text-amber-400 hover:text-amber-300 cursor-pointer">Terms of Service</span> and <span className="text-amber-400 hover:text-amber-300 cursor-pointer">Privacy Policy</span>
          </div>
        </div>
      </div>
    </div>
